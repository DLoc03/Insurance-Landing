      ...
      >
        ...
        >
          ...
          <Typography
            ...
            mt={2}
          >
            Khi chọn Ms. Phạm Tuyền, bạn không chỉ nhận được một hợp đồng bảo
            hiểm, mà còn có một người bạn đồng hành đáng tin cậy trên hành trình
            bảo vệ sức khỏe và tài chính cho bản thân & gia đình.
          </Typography>
        </Grid>
        <Box
          flex={1}
          ...
          {advantageList.map((advantage, index) => (
            ...
            >
              ...
              <Typography
                ...
                color={hoverIndex === index ? "secondary.main" : "primary.main"}
                fontWeight={700}
