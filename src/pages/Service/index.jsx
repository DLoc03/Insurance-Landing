          ...
          <>
            ...
            >
              ...
              <Typography variant="body2" color="white">
                Manulife đưa ra phương pháp tư vấn dựa trên mục tiêu của khách
                hàng như:
              </Typography>
              <Typography variant="body2" color="white">
                <LabelIcon sx={{ fontSize: 12 }} /> Bảo vệ (tử vong, thương tật,
                bệnh hiểm nghèo, sức khỏe…)
              </Typography>
              <Typography variant="body2" color="white">
                <LabelIcon sx={{ fontSize: 12 }} /> Đầu tư, tiết kiệm cho giáo
                dục, hưu trí…
              </Typography>
              <Typography variant="body2" color="white">
                Khách hàng được hướng dẫn chọn sản phẩm phù hợp nhất thông qua
                tư vấn cá nhân hóa.
              </Typography>
            </Grid>
            <Grid size={{ xs: 12, md: 6 }}>
